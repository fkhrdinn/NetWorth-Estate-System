<div>
    ...
    x-on:livewire-upload-progress="progress = $event.detail.progress">
        <div class="row mb-3">
            ...
            <div class="col-md-10">
                <input class="form-control" type="file" wire:model.debounce.500ms="images" @if($image) disabled @endif>
            </div>
        </div>
        ...
        <div class="row mb-3 mx-auto col-md-5">
            <img src="{{$images->temporaryUrl()}}" alt="temp" class="img-thumbnail">
        </div>
        @elseif($image)
        <div class="row mb-3 mx-auto col-md-5">
            <img src="{{$image}}" alt="temp" class="img-thumbnail">
        </div>
        @endif
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-10">
            <input class="form-control" type="number" wire:model.debounce.500ms="price" @if($model) disabled @endif>
        </div>
    </div>
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="d-flex justify-content-end">
            <input wire:click.prevent="edit" type="submit" class="btn btn-primary" value="Update">
        </div>
        @else
        <div class="d-flex justify-content-end">
            <input wire:click.prevent="create" type="submit" class="btn btn-primary" value="Create">
        </div>
        @endif      
    </div>
</div>
