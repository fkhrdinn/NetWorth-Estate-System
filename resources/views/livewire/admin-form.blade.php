<div>
    ...
    <div class="row mb-3">
        <label for="inputEmail3" class="col-md-2 col-form-label">Price (RM)</label>
        <div class="col-md-10">
            <input class="form-control" type="number" wire:model.debounce.500ms="price">
        </div>
    </div>
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        <label for="inputEmail3" class="col-md-2 col-form-label">Median Income Area</label>
        <div class="col-md-10">
            <input class="form-control" type="number" wire:model.debounce.500ms="median">
        </div>
    </div>
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        <label for="inputEmail3" class="col-md-2 col-form-label">Price Per Square Feet</label>
        <div class="col-md-10">
            <input class="form-control" type="number" wire:model.debounce.500ms="pricePerSquareFeet">
        </div>
    </div>
    <div class="row mb-3">
        <label for="inputEmail3" class="col-md-2 col-form-label">Traffic</label>
        <div class="col-md-10">
            <select class="form-select" aria-label="Default select example" wire:model.debounce.500ms="traffic">
                <option selected>--Traffic Type--</option>
    ...
    <div class="row mb-3">
        <div class="d-flex justify-content-end">
            <input wire:click.prevent="create" type="submit" class="btn btn-primary" value="Train">
        </div>
    </div>
</div>